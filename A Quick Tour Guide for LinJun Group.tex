...
\section{相对论量子力学}
薛定谔方程有很多不尽如人意的地方，比如说它并不能使用自身的理论解释电子自旋的由来，比如它根本没搞定相对论效应的事情。在王老师的量子化学课上会教标量相对论效应作为微扰对能量的修饰，但最为关键的光速不变原理仍旧没有在量子力学体系中得到体系。而成功将洛伦兹变换应用到量子力学的理论便是狄拉克的相对论量子力学体系。

\subsection{经典电动力学}
在描述相对论量子力学之前，编者（李睿）认为有必要了解一下经典电动力学。正如爱因斯坦从麦克斯韦方程组看到光速不变原理建立了狭义相对论一样，以麦克斯韦方程组作为出发点的电动力学是直接满足狭义相对论，即服从洛伦兹变换的。因此在讲述相对论量子力学的时候，我们也需要用经典电动力学作为其中的一个出发点。
...
\begin{equation}
	\begin{cases}
		...
		\nabla \times \boldsymbol{H} = \frac{\partial \boldsymbol{E}}{\partial t} 
	\end{cases}.
\end{equation}
我们提到过任何向量场的旋度的散度为零，即
\[
	\nabla \cdot (\nabla \times \boldsymbol{A}) = 0
.\] 
所以对于一个磁场总会有一个对应的向量场$\boldsymbol{A}$,使得
\begin{equation}
	\boldsymbol{B} = \nabla \times \boldsymbol{A} .
\end{equation}
$\boldsymbol{A}$便称为磁矢势。如果你记忆力比较好，你应该还记得一个标量场的梯度是没有旋度的\footnote{没有印象？不妨作为一个很小很小的作业。}，因此这个标量场的梯度加在磁矢势中会完全没有任何影响，也就是
\[
	\boldsymbol{B} = \nabla \times (\boldsymbol{A} + \nabla \lambda)
.\] 
其中$\lambda$为任意一个标量场。为了搞定这个事情，有两个规范进行约束，一个是
\begin{equation}
